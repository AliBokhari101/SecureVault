...
const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-cyber-black cyber-grid-bg flex items-center justify-center px-4 relative overflow-hidden">
            ...
            >
                ...
                <div className="text-center mb-6 sm:mb-8">
                    ...
                    <p className="font-mono text-cyber-offwhite text-xs sm:text-sm">
                        <span className="text-cyber-red-500">[AUTHENTICATION REQUIRED]</span>
                    </p>
                </div>
                ...
                <div className="neon-card p-6 sm:p-8 relative">
                    ...
                    <div className="mt-4 sm:mt-6 text-center">
                        <p className="font-mono text-cyber-offwhite text-xs sm:text-sm">
                            NO ACCOUNT? {' '}
                            <Link to="/register" className="text-cyber-red-500 font-bold hover:underline">
                                [REGISTER]
                            </Link>
                        </p>
                    </div>
